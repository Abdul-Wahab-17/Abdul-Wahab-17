...
<a href="https://github.com/Abdul-Wahab-17">
  <img src="https://img.shields.io/badge/Abdul--Wahab--17-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"/>
</a>
<a href="https://www.linkedin.com/in/abdul-wahab-mk/">
  <img src="https://img.shields.io/badge/abdul--wahab--mk-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/>
</a>
...
- Developed an automated test case validating `RX_DROP` counter behaviour under XON/XOFF (IEEE 802.3x) pause frames.  
- Addressed a subtle edge case in control‑plane statistics accuracy.  
- Pull request merged into the official `sonic-mgmt` repository.  
`sonic-net/sonic-mgmt#20543`
